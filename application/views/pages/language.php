<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Gestión de Lenguajes</a>
            </div>
      ...
      <div class="content">
          <div class="col-md-8">
            <div class="card card-user">
              ...
              <div class="card-body">
                <form action="<?php base_url();?>languages/add" method='post'>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Lenguaje" name="name">
                        <button type="submit" class="btn btn-primary btn-round" float='right'>Agregar Lenguaje</button>
                      </div>
                    </div>
                </form>
              </div>
      ...
      <script src="<?php echo base_url(); ?>assets/js/language-event-handler.js"></script>