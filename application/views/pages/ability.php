<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
          ...
          <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Agregar Competencias</h5>
              </div>
              <div class="card-body">
                <form action="<?php base_url();?>abilities/add" method='post'>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Competencia" name="name">
                        <button type="submit" class="btn btn-primary btn-round" float='right'>Agregar Competencia</button>
                      </div>
                    </div>
                </form>
              </div>
      ...
      <script src="<?php echo base_url(); ?>assets/js/ability-event-handler.js"></script>
