...
CREATE TABLE `applicants`  (
  ...
  PRIMARY KEY (`id`, `department_id`, `training_id`, `ability_id`, `experience_id`, `company_id`, `type_id`) USING BTREE,
...
CREATE TABLE `employees`  (
  ...
  `secondlastname` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `department_id` int(11) NOT NULL,
  ...
  `type_id` int(11) NOT NULL,
  `state_id` int(11) NOT NULL,
  PRIMARY KEY (`id`, `department_id`, `state_id`, `type_id`) USING BTREE,
  INDEX `department_id`(`department_id`) USING BTREE,
  INDEX `state_id`(`state_id`) USING BTREE,
  INDEX `type_id`(`type_id`) USING BTREE,
